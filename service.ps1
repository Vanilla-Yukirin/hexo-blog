# ================================
# Hexo 本地服务器脚本（Windows）
# 读取 deploy.env -> 生成 _config.encrypt.yml -> hexo clean + s
# ================================
...
Write-Host "[INFO] Running hexo server (merge main+encrypt config)"
npx --yes hexo s --config "_config.main.yml,_config.encrypt.yml"
